        ...
        for y in range(7):
            try:
                if board[x][y] == board[x - 1][y + 1] == board[x - 2][y + 2] == board[x - 3][y + 3] == letter:
                    ...
                    return True
            #             elif (board[x][y] == letter) and (board[x + 1][y + 1] == letter) and (board[x + 2][y + 2] == letter) and (board[x + 3][y + 3] == letter):
            #                return True
            #             elif (board[y][x] == letter) and (board[y + 1][x-1] == letter) and (board[y + 2][x-2] == letter) and (board[y + 3][x-3] == letter):
            #                 return True
            # if board[6-x][6-y] == letter and (board[6-x][5-y] == letter) and (board[6-x][4-y] == letter) and (board[6-x][3-y] == letter):
            #    return True
            except IndexError:
                continue
